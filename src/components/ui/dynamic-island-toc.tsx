...
export function DynamicIslandTOC({
  ...
  // Don't render the island if there are no headings to track
      ...
      >
        <motion.div
          ...
          animate={{
            ...
            height: isExpanded ? 420 : 52,
            borderRadius: isExpanded ? 24 : 26,
          }}
          transition={islandTransition}
          style={{ cursor: isExpanded ? "default" : "pointer" }}
          className="relative overflow-hidden border border-white/10 bg-[hsl(var(--card))] text-[hsl(var(--foreground))] shadow-2xl shadow-black/50"
        >
          <motion.div
            initial={false}
            animate={{
          ...
          >
            <div className="h-2 w-2 shrink-0 rounded-full bg-[hsl(var(--foreground))]" />
            ...
            <div className="relative flex h-full flex-1 items-center overflow-hidden text-left">
              <AnimatePresence mode="popLayout" initial={false}>
                <motion.span
                  ...
                  className="block w-full overflow-hidden text-ellipsis whitespace-nowrap text-sm font-medium text-[hsl(var(--foreground))]"
                >
          ...
          >
            <div className="flex shrink-0 items-center justify-between px-6 pb-3 pt-5">
              <span className="text-[11px] font-semibold tracking-[0.08em] text-[hsl(var(--muted-foreground))]">
                ON THIS PAGE
              </span>
              <button
                onClick={(e) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isActive &&
                          "bg-[hsl(var(--foreground)/0.10)] font-medium text-[hsl(var(--foreground))]",
                        !isActive &&
                          isHovered &&
                          "bg-[hsl(var(--foreground)/0.05)] text-[hsl(var(--foreground)/0.85)]",
                        !isActive &&
                          !isHovered &&
                          "bg-transparent text-[hsl(var(--foreground)/0.45)]",
                      )}
                    >
                      ...
                      <motion.div
                        ...
                        className="ml-3 h-1.5 w-1.5 shrink-0 rounded-full bg-[hsl(var(--foreground))]"
                      />
                    </button>
                  );
                })}
