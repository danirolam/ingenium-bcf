    ...
    <div className="is-wrap">
      <div className="is-label">
        ...
        <Tooltip
          ...
          body="The brief agent sets it (low, medium, high, or critical) from the bill's counsel-approved changes and this client's profile, based on how materially the changes would affect the client's obligations and operations. When the analysis spans several provision batches, the highest severity wins. (This is distinct from the stage-3 scan band, a 0 to 100 relevance score.)"
        >
          <span
